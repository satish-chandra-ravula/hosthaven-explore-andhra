    ...
    <section className="py-6 bg-cream-light">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
          {/* 24 Hour Check-In */}
          <div className="bg-card rounded-xl p-4 shadow-card border-2 border-gold/20 flex flex-col items-center text-center hover:shadow-card-hover hover:border-gold/35 transition-all">
          ...
          <Link 
            to="/contact"
            className="bg-card rounded-xl p-4 shadow-card border-2 border-gold/20 flex flex-col items-center text-center hover:shadow-card-hover hover:border-gold/35 transition-all"
          >
            <div className="w-12 h-12 rounded-full bg-gold/10 flex items-center justify-center mb-3">
