    ...
    <section className="py-6 bg-cream-light">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
          {/* 24 Hour Check-In */}
          <div className="bg-card rounded-xl p-4 shadow-card flex flex-col items-center text-center">
          ...
          <Link 
            to="/contact"
            className="bg-card rounded-xl p-4 shadow-card flex flex-col items-center text-center hover:shadow-card-hover transition-shadow"
          >
