...
const homes: RentalHome[] = [
  {
    ...
    bedrooms: 3,
    guests: 6,
    amenities: ["Kitchen", "Garden", "Parking", "WiFi"],
  },
  {
    id: "2",
    ...
    rating: 4.5,
    reviews: 67,
    image: "https://images.unsplash.com/photo-600585154340-be6161a56a0c?w=800",
    bedrooms: 2,
    guests: 4,
    amenities: ["Lake View", "Kitchen", "Fireplace", "WiFi"],
  },
  {
    id: "3",
    name: "Beach House",
    ...
    bedrooms: 4,
    guests: 8,
    amenities: ["Beach Access", "Pool", "Kitchen", "BBQ"],
  },
  {
    id: "4",
    ...
    bedrooms: 3,
    guests: 6,
    amenities: ["Mountain View", "Kitchen", "Fireplace", "Garden"],
  },
  {
    id: "5",
    ...
    bedrooms: 5,
    guests: 10,
    amenities: ["Courtyard", "Kitchen", "Heritage", "WiFi"],
  },
  {
    id: "6",
    ...
    bedrooms: 2,
    guests: 4,
    amenities: ["Temple Proximity", "Kitchen", "Parking", "WiFi"],
  },
];
